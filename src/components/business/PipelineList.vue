...
<div class="page">
    <div v-show="pageState == 1">
          <header class="header sticky">
              ...
              <a class="calcfont calc-tianjia add-icon" @click="addPipeline" ></a>
          </header>
          ...
          <div class="list-mode-div" v-show="queryObj.groupByMode == 'List'">
                <vue-scroll v-show="!noData" :showToTop="false" :options="{ pullup: true, pulldown: true }" :scrollbar="false" ref="scroll" @pulldown="pulldown" @pullup="pullup">
                    <div v-if="listData !=null && listData != undefined && listData.length > 0" class="group-item-list dealPipeline-list">
          ...
          <div class="group-mode-div" v-show="queryObj.groupByMode != 'List'">
                <div v-if="groupData !=null && groupData != undefined && groupData.length > 0" id="opportunitiesList" data-fromtype="dealPipeline">
                      <div v-for="group in groupData" :key="group.GroupID" class="list-group-div group-div">
                              ...
                              <div v-if="group.items !=null && group.items != undefined && group.items.length > 0" class="group-item-list dealPipeline-list">
...
export default {
    ...
    return{
        ...
        listData:[{
            "AutoID": 427,
            "TheName": "Joy Air Co., Ltd._Trading",
            "Memo": "讨论738租赁合同",
            "CurrentState": "In Progress",
            "CurrentStateNew": 38,
            "IsFollow": "calc-noshoucang",
            "IsMeetingExist": "true",
            "MeetingTitle": "幸福航空738租赁合同讨论会",
            "BeginTime": "2019-11-12T23:17:00"
          }, {
            "AutoID": 426,
            "TheName": "Joy Air Co., Ltd._Trading",
            "Memo": "讨论738租赁合同",
            ...
            "IsFollow": "calc-noshoucang",
            "IsMeetingExist": "true",
            "MeetingTitle": "738租赁合同讨论",
            "BeginTime": "2019-11-05T13:52:00"
          }, {
            "AutoID": 424,
            "TheName": "Joy Air Co., Ltd._Trading",
            "Memo": "讨论738租赁合同",
            ...
            "IsFollow": "calc-noshoucang",
            "IsMeetingExist": "true",
            "MeetingTitle": "幸福738租赁讨论会",
            "BeginTime": "2019-10-29T13:39:00"
          }, {
            "AutoID": 397,
            "TheName": "Joy Air Co., Ltd._Trading",
            "Memo": "确认后期交付及海关操作事宜",
            ...
            "IsFollow": "calc-noshoucang",
            "IsMeetingExist": "true",
            "MeetingTitle": "与幸福航及空港管委会沟通",
            "BeginTime": "2019-10-18T09:31:00"
          }, {
            "AutoID": 394,
            "TheName": "MSN41121，41125_幸福航空有限责任公司_Trading",
            "Memo": "确定MSN41121飞机的接收计划",
            "CurrentState": "In Progress",
            "CurrentStateNew": 38,
            "IsFollow": "calc-noshoucang",
            "IsMeetingExist": "true",
            "MeetingTitle": "幸福航飞机引进接收计划沟通",
            "BeginTime": "2019-10-22T08:37:00"
          }, {
            "AutoID": 379,
            "TheName": "瑞丽航空有限公司_Trading",
            "Memo": "洽谈LOI",
            "CurrentState": "In Progress",
            "CurrentStateNew": 38,
            "IsFollow": "calc-noshoucang",
            "IsMeetingExist": "true",
            "MeetingTitle": "瑞丽航空737-800租赁",
            "BeginTime": "2019-09-23T08:45:00"
          }, {
            "AutoID": 377,
            "TheName": "瑞丽航空有限公司_Trading",
            "Memo": "LOI第二次沟通，主要条款达成一致",
            "CurrentState": "In Progress",
            "CurrentStateNew": 38,
            "IsFollow": "calc-noshoucang",
            "IsMeetingExist": "true",
            "MeetingTitle": "瑞丽航空737-800租赁LOI",
            "BeginTime": "2019-10-09T08:33:00"
          }, {
            "AutoID": 365,
            "TheName": "瑞丽航空有限公司_Trading",
            "Memo": "对提供给瑞丽航空的LOI 进行沟通",
            "CurrentState": "In Progress",
            "CurrentStateNew": 38,
            "IsFollow": "calc-noshoucang",
            "IsMeetingExist": "true",
            "MeetingTitle": "与瑞丽航空LOI 沟通会",
            "BeginTime": "2019-10-12T09:47:00"
          }, {
            "AutoID": 364,
            "TheName": "幸福航空有限责任公司_Trading",
            "Memo": "沟通幸福航LOI",
            "CurrentState": "In Progress",
            "CurrentStateNew": 38,
            "IsFollow": "calc-noshoucang",
            "IsMeetingExist": "true",
            "MeetingTitle": "幸福航合同谈判",
            "BeginTime": "2019-10-29T10:00:00"
          }],
        //分组数据(分组模式为非List)
        groupData:[{
              "GroupID": 8,
