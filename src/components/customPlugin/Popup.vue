...
<div>
    ...
    <div id="popupContent" class="popup-content">
        ...
        <div class="item-field">
            ...
            <div class="row">
                <div class="field-value can-operation" @click="callPhone">{{popupData.Phone}}</div>
            </div>
        </div>
